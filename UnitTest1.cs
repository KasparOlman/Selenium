...
namespace SeleniumCSharp
{
	public class Tests
	{
		...
		IWebDriver driver;
		String test_url = "https://kasparolman22.thkit.ee/";
		...
		{
			driver.Url = test_url;
			driver.Navigate().GoToUrl("https://kasparolman22.thkit.ee/");

			try { IWebElement sButton2 = driver.FindElement(By.XPath("//*[@id=\"menu-item-13\"]")); sButton2.Click(); } catch (Exception) { }
            Thread.Sleep(2500);
    //        for (int a = 0; a < 1; a++)
				//{
				//	Thread.Sleep(2500);
		...
		public void test_page2()
		{
			...
			try { IWebElement sButton2 = driver.FindElement(By.XPath("//*[@id=\"menu-item-584\"]")); sButton2.Click(); } catch (Exception) { }
			Thread.Sleep(2500);
		}
		...
		public void test_page3()
		{
			...
			try { IWebElement sButton2 = driver.FindElement(By.XPath("//*[@id=\"menu-item-12\"]")); sButton2.Click(); } catch (Exception) { }
			Thread.Sleep(2500);
			...
			for (int i = 0; i < sText.Count; i++)
			{
				try { sText[i].Click(); sText[i].SendKeys("Kaspar"); } catch (Exception) { }
			}
			Thread.Sleep(2500);
			var sTextArea = driver.FindElements(By.XPath("//*[@id=\"wpforms-617-field_1\"]"));
			for (int i = 0; i < sTextArea.Count; i++)
			{
				try { sTextArea[i].Click(); sTextArea[i].SendKeys("kaspar@hot.ee"); } catch (Exception) { }
			}
			Thread.Sleep(2500);
			var sTextArea1 = driver.FindElements(By.XPath("//*[@id=\"wpforms-617-field_2\"]"));
			for (int i = 0; i < sTextArea1.Count; i++)
			{
				try { sTextArea1[i].Click(); sTextArea1[i].SendKeys("privunn"); } catch (Exception) { }
			}
			Thread.Sleep(2500);
        ...
        public void test_page4()
        {
            ...
            try { IWebElement sButton1 = driver.FindElement(By.XPath("//*[@id=\"menu-item-584\"]/a")); sButton1.Click(); } catch (Exception) { }
            Thread.Sleep(2500);
